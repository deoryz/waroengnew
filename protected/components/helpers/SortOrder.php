...
class SortOrder {
    ...
    public function sortButton($data, $controller, $nama_model='', $varGet='', $varFk='')
    {
        if (isset($varGet)) {
            $str = '';
    ...
    public function sortUlang($nama_model, $varGet='', $varFk='')
    {
        if (isset($varGet)) {
            $model = new $nama_model;
    ...
    public function sortTo($id, $to, $nama_model, $varGet='', $varFk='')
    {
        if (isset($varGet)) {
            $model = new $nama_model;
            $id = $id;
