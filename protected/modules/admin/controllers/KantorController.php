...
class KantorController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Kantor']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("KantorController Create $model->id");
	...
	public function actionIndex()
	{
		...
		if(isset($_POST['Kantor']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("KantorController Update $model->id");
	...
	public function actionIndex2()
	{
		...
		$dataProvider=new CActiveDataProvider('Kantor');
