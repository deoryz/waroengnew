...
class MasterStateController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MasterState']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("MasterStateController Create $model->id");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['MasterState']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("MasterStateController Update $model->id");
