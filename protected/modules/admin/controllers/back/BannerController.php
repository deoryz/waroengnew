...
class BannerController extends ControllerAdmin
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Banner']))
		{
			...
			if($model->validate()){
				...
				try
				{
					$img->saveAs(Yii::getPathOfAlias('webroot').'/images/banner/'.$model->image);
					$model->save();
					Log::createLog("BannerController Create $model->id");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Banner']))
		{
			...
			if($model->validate()){
				...
				{
					if($img->name!=''){//jika di edit
						$img->saveAs(Yii::getPathOfAlias('webroot').'/images/banner/'.$model->image);//upload file
						@unlink(Yii::app()->basePath."/../images/banner/".$image);
					}
					$model->save();
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			unlink(Yii::app()->basePath."/../images/banner/".$data->image);
			Log::createLog("Banner Delete $data->id");
			$data->delete();
			Banner::model()->sortUlang($this->varGet, $this->varFk);
