...
class ReservationController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Reservation']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("ReservationController Create $model->id");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Reservation']))
		{
			...
			if($model->validate()){
				...
				{
					$model->save();
					Log::createLog("ReservationController Update $model->id");
